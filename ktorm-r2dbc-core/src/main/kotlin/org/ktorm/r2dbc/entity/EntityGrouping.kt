...
public class EntityGrouping<E : Any, T : BaseTable<E>, K : Any>(
     ...
     */
    public suspend fun asKotlinGrouping(): Grouping<E, K?> {
        ...
        val allEntities = ArrayList<E>()
        val allEntitiesWithKeys = IdentityHashMap<E, K?>()
        Query(sequence.database,expr).asFlow().collect {
            val entity = sequence.sourceTable.createEntity(it)
            val groupKey = keyColumn.sqlType.getResult(it, expr.columns.size - 1)
            allEntities += entity
            allEntitiesWithKeys[entity] = groupKey
        }
        return object : Grouping<E, K?> {
...
public suspend inline fun <E : Any, T : BaseTable<E>, K, C> EntityGrouping<E, T, K>.aggregateColumns(
...
@OptIn(ExperimentalTypeInference::class)
@OverloadResolutionByLambdaReturnType
public suspend inline fun <E : Any, T : BaseTable<E>, K, C, M> EntityGrouping<E, T, K>.aggregateColumnsTo(
    destination: M,
    aggregationSelector: (T) -> ColumnDeclaring<C>
    ...
    Query(sequence.database,expr).asFlow().collect {
        val key = keyColumn.sqlType.getResult(it, 0)
        val value = aggregation.sqlType.getResult(it, 1)
 ...
 */
public suspend fun <E : Any, T : BaseTable<E>, K> EntityGrouping<E, T, K>.eachCount(): Map<K?, Long> where K : Any {
...
public suspend fun <E : Any, T : BaseTable<E>, K, M> EntityGrouping<E, T, K>.eachCountTo(
    destination: M
): M where K : Any, M : MutableMap<in K?, Long> {
    return aggregateColumnsTo(destination as MutableMap<in K?, Long?>) { count() } as M
}
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K, C> EntityGrouping<E, T, K>.eachSumBy(
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K, C, M> EntityGrouping<E, T, K>.eachSumByTo(
    destination: M,
    columnSelector: (T) -> ColumnDeclaring<C>
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K, C> EntityGrouping<E, T, K>.eachMaxBy(
    columnSelector: (T) -> ColumnDeclaring<C>
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K, C, M> EntityGrouping<E, T, K>.eachMaxByTo(
    destination: M,
    columnSelector: (T) -> ColumnDeclaring<C>
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K, C> EntityGrouping<E, T, K>.eachMinBy(
    columnSelector: (T) -> ColumnDeclaring<C>
): Map<K?, C?> where K : Any, C : Comparable<C> {
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K, C, M> EntityGrouping<E, T, K>.eachMinByTo(
    destination: M,
    columnSelector: (T) -> ColumnDeclaring<C>
): M where K : Any, C : Comparable<C>, M : MutableMap<in K?, in C?> {
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K> EntityGrouping<E, T, K>.eachAverageBy(
 ...
 */
public suspend inline fun <E : Any, T : BaseTable<E>, K, M> EntityGrouping<E, T, K>.eachAverageByTo(
    destination: M,
    columnSelector: (T) -> ColumnDeclaring<out Number>
 ...
 */
public suspend inline fun <E : Any, K : Any, R> EntityGrouping<E, *, K>.aggregate(
 ...
 */
public suspend inline fun <E : Any, K : Any, R, M : MutableMap<in K?, R>> EntityGrouping<E, *, K>.aggregateTo(
    destination: M,
    operation: (key: K?, accumulator: R?, element: E, first: Boolean) -> R
): M {
 ...
 */
public suspend inline fun <E : Any, K : Any, R> EntityGrouping<E, *, K>.fold(
 ...
 */
@Suppress("UNCHECKED_CAST")
public suspend inline fun <E : Any, K : Any, R, M : MutableMap<in K?, R>> EntityGrouping<E, *, K>.foldTo(
    destination: M,
    initialValueSelector: (key: K?, element: E) -> R,
    operation: (key: K?, accumulator: R, element: E) -> R
): M {
 ...
 */
public suspend inline fun <E : Any, K : Any> EntityGrouping<E, *, K>.reduce(
 ...
 */
public suspend inline fun <E : Any, K : Any, M : MutableMap<in K?, E>> EntityGrouping<E, *, K>.reduceTo(
    destination: M,
    operation: (key: K?, accumulator: E, element: E) -> E
): M {
    return aggregateTo(destination) { key, accumulator, element, first ->
